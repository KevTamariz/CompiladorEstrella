...
/* Funcion que define los tipos de valores que se pueden asignar a una variable, 
  ...
  final public void tipoValor() throws ParseException {
    if (jj_2_3(2)) {
      jj_consume_token(ENTEROS);
    } else if (jj_2_4(2)) {
      jj_consume_token(DECIMALES);
    } else {
      jj_consume_token(-1);
      throw new ParseException();
    }
...
/* Funcion que define una una operacion aritmetica en una asginacion: 
    ...
    a = 2 * 4 
*/
  final public void operacionAritmetica() throws ParseException {
    label_1:
    while (true) {
      if (jj_2_18(2)) {
        ;
...
/* Funcion que define una operacion relacional: 
    ...
    10 <= 20
*/
  final public void operacionRelacional() throws ParseException {
    if (jj_2_21(2)) {
      jj_consume_token(IDENTIFICADOR);
    } else if (jj_2_22(2)) {
      tipoValor();
...
/* Funcion que define una operacion logica
    b > c && 45 == z || 4 != 3
*/
  final public void operacionLogica() throws ParseException {
    operacionRelacional();
    label_2:
    while (true) {
      if (jj_2_25(2)) {
 ...
 */
  final public void imprimirMensaje() throws ParseException {
 ...
 */
  final public void sentenciaSiNo() throws ParseException {
...
*/
  final public void sentenciaSelector() throws ParseException {
...
/* Funcion que define la estructura de la sentencia seleccion:
    ...
    seleccion 2 :
        imprimir : "Mundo";
*/
  final public void sentenciaSeleccion() throws ParseException {
    jj_consume_token(SELECCION);
    tipoValor();
    jj_consume_token(DOSPUNTOS);
    label_7:
    while (true) {
...
/* Funcion de que define la estructura de la sentencia automatico:
    automatico:
        ...
        romper;
*/
  final public void sentenciaAutomatico() throws ParseException {
...
/* Funcion que define la estructura del la condicion para el ciclo para:
    ...
    y = 0.1; y < 1.0; y = y + 0.1 
 */
  final public void condicionalPara() throws ParseException {
    if (jj_2_49(2)) {
      if (jj_2_47(2)) {
        jj_consume_token(ENTERO);
      } else if (jj_2_48(2)) {
 ...
 */
  final public void metodoPrincipal() throws ParseException {
...
/* Funcion que manda a llamar a todas las estructuras que posee el lenguaje */
  final public 
void codigo() throws ParseException {
    if (jj_2_55(2)) {
      declaracionVariable();
    } else if (jj_2_56(2)) {
      asignacionVariable();
 ...
 {
    if (jj_scan_token(DECIMALES)) return true;
    return false;
  }
 ...
 {
    if (jj_scan_token(ENTEROS)) return true;
    return false;
  }
  ...
  private boolean jj_3R_27()
 {
    ...
    if (jj_scan_token(PARENTESISA)) return true;
    return false;
  }
 ...
 {
    if (jj_scan_token(AUTOMATICO)) return true;
 ...
 {
    if (jj_scan_token(SELECCION)) return true;
    if (jj_3R_13()) return true;
    return false;
  }
