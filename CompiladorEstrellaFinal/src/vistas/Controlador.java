  ...
  public void analisis(InputStream in) {
    if (!ventana.getAreaCodigo().getText().isEmpty()) {
      try {
        ...
        //ventana.getAreaTerminal().append("********Iniciando análisis********\n\n");
        //El primer proceso realizado es el analisis lexico
        //ventana.getAreaTerminal().append("Análisis Léxico: \n");
        comp.analisisLexico();
        ventana.getAreaTerminal().append("Análisis Léxico exitoso\nErrores encontrados: 0\n\n");
        //El segundo proceso realizado es el analisis sintactico
       // ventana.getAreaTerminal().append("Análisis Sintáctico: \n");
        comp.analisisSintactico();
        ventana.getAreaTerminal().append("Análisis Sintáctico exitoso\nErrores encontrados: 0\n\n");
        //El tercer proceso realizado es el analisis semantico
        //ventana.getAreaTerminal().append("Análisis Semántico: \n");
        semantico.realizarAnalisis();
        ventana.getAreaTerminal().append("Análisis Semántico exitoso\nErrores encontrados: 0\n\n");
        ...
        ventana.getAreaTerminal().append("Análisis Fallido");
